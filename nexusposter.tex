...
\begin{tcolorbox}[enhanced,width=\linewidth,height=14.5cm,arc=5mm,
...
% \vspace{-1.5cm}
\begin{center}
\color{white}\fontsize{44}{1}\textbf{https://www.isis.stfc.ac.uk\\https://europeanspallationsource.se}
\end{center}
\end{column}
\end{columns}
\end{frame}
